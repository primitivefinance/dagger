export const dfmmABI = [
    ...
    { type: 'error', name: 'InvalidDuplicateTokens', inputs: [] },
    {
        type: 'error',
        name: 'InvalidInvariant',
        inputs: [{ name: 'invariant', type: 'int256', internalType: 'int256' }],
    },
    { type: 'error', name: 'InvalidMaximumTokens', inputs: [] },
    { type: 'error', name: 'InvalidMinimumTokens', inputs: [] },
    { type: 'error', name: 'InvalidReserves', inputs: [] },
    { type: 'error', name: 'InvalidTokenDecimals', inputs: [] },
