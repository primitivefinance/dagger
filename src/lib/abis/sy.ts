export const SYABI = [
    ...
    },
    {
        ...
        name: 'exchangeRate',
        inputs: [],
        outputs: [{ name: 'res', type: 'uint256', internalType: 'uint256' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
    ...
    },
    {
        ...
        inputs: [],
        outputs: [
            { name: 'res', type: 'address[]', internalType: 'address[]' },
        ],
        stateMutability: 'view',
    },
    {
    ...
    { type: 'error', name: 'SYZeroDeposit', inputs: [] },
    { type: 'error', name: 'SYZeroRedeem', inputs: [] },
    {
        type: 'error',
        name: 'StringTooLong',
