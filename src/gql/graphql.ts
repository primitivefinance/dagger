...
export type PoolWithTokensFragment = { __typename?: 'Pool', id: any, tokens: Array<string>, reserves: Array<number>, liquidity: number, lpToken: string, name: string, initTimestamp: any, poolTokens?: { __typename?: 'PoolTokenPage', items: Array<{ __typename?: 'PoolToken', token: { __typename?: 'Token', id: string, name: string, symbol: string, decimals: number } }> } | null } & { ' $fragmentName'?: 'PoolWithTokensFragment' };
