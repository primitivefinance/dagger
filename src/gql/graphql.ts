...
export type PoolWithTokensFragment = { __typename?: 'Pool', id: any, tokens: Array<string>, reserves: Array<number>, liquidity: number, lpToken: string, name: string, initTimestamp: any, poolTokens?: { __typename?: 'PoolTokenPage', items: Array<{ __typename?: 'PoolToken', token: { __typename?: 'Token', id: string, name: string, symbol: string, decimals: number } }> } | null, strategy: { __typename?: 'Strategy', name: string } } & { ' $fragmentName'?: 'PoolWithTokensFragment' };
...
export type PositionItemFragment = { __typename?: 'Position', id: string, liquidity: number, accountId: string, poolId: any, pool: (
    { __typename?: 'Pool' }
    & { ' $fragmentRefs'?: { 'PoolItemFragment': PoolItemFragment } }
