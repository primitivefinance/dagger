...
export type PositionItemFragment = { __typename?: 'Position', id: string, liquidity: number, accountId: string, poolId: any, pool: { __typename?: 'Pool', id: any } } & { ' $fragmentName'?: 'PositionItemFragment' };
