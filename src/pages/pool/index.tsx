    ...
    <div className="container mx-auto max-w-4xl my-8 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-row items-center gap-5">
          ...
          <div className="flex gap-1 items-center">
            <p className="font-bold">{pool?.poolTokens[1].symbol}</p>
            <a
      ...
      <div className="flex flex-row gap-4">
        ...
        <div className="bg-dagger1 rounded-lg border border-dagger2 border-solid p-2 flex flex-row gap-2 items-center">
          ...
          <p className="text-sm">
            ...
            {pool.tokenX.symbol}{" "}
            <span className="text-xs">per {pool.tokenY.symbol}</span>
          </p>
        </div>
      </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col">
                ...
                <p className="text-dagger3 text-xs">
                  $
                  {userPosition!
                    ? (userPosition.liquidity / pool.liquidity) *
                        pool.reserveX *
              ...
              <div className="flex flex-col">
                ...
                <p className="font-bold">
                  {userPosition!
                    ? (userPosition.liquidity / pool.liquidity) * pool.reserveX
                    : "0.0"}{" "}
                  {pool.tokenX.symbol}{" "}
              ...
              <div className="flex flex-col">
                ...
                <p className="font-bold">
                  {userPosition!
                    ? userPosition.liquidity.toLocaleString(undefined)
                    : "0.0"}
                </p>
              </div>
            </div>
          ...
          <div className="bg-dagger1 rounded-lg border border-dagger2 border-solid p-4 self-start w-full">
            <div className="flex flex-col gap-4">
              <div className="grid grid-cols-2 border-solid border border-dagger2 w-full rounded-xl">
                <button
                  className={`border-0 ${
                    isAddLiquidity ? "bg-dagger2" : "border-0"
                  }`}
                ...
                <button
                  className={`border-0 ${
                    isAddLiquidity ? "border-0" : "bg-dagger2"
                  }`}
              ...
              {isAddLiquidity ? (
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-dagger3 text-xs">
                      Increase your position by adding liquidity into the pool.
                    </p>
                  </div>
                  <TokenAmountInput
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-dagger3 text-xs">
                      Decrease your position by removing liquidity from the
                      pool.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-row gap-1 items-center justify-end">
                    ...
                    <p className="text-dagger4 text-sm">
                      {pool.tokenY.symbol}
                      <span className="text-dagger3">.</span>
                    </p>
                  </div>
                </div>
              )}
                  ...
                  if (address === undefined) {
                    ...
                    if (isAddLiquidity) {
                      ...
                      const data = await deallocateGivenX(
                        pool.id,
                        parseEther(((x * range) / 100).toString())
                      );
          ...
          <div className="bg-dagger1 rounded-lg border border-dagger2 border-solid p-4 self-start w-full">
            <div className="grid gap-4 grid-cols-2">
              ...
              <div className="flex flex-col">
                ...
                <p className="font-bold">
                  {pool.reserveX.toLocaleString(undefined)} {pool.tokenX.symbol}{" "}
                  <span className="text-xs font-normal text-dagger3">
                    ($
                    {(
                      prices[pool.tokenX.symbol] * pool.reserveX
                    ).toLocaleString(undefined)}
                    )
                  </span>
                </p>
              ...
              <div className="flex flex-col">
                ...
                <p className="font-bold">
                  {pool.reserveY.toLocaleString(undefined)} {pool.tokenY.symbol}{" "}
                  <span className="text-xs font-normal text-dagger3">
                    ($
                    {(
                      prices[pool.tokenY.symbol] * pool.reserveY
                    ).toLocaleString(undefined)}
                    )
                  </span>
                </p>
            ...
            <div className="grid gap-4 grid-cols-2">
              ...
              <div className="flex flex-col">
                ...
                <a href="#" className="flex flex-row gap-1 font-bold">
                  {shortAddress(pool.parameters.controller as `0x${string}`)}{" "}
                  <LinkIcon />
                </a>
              </div>
              <div className="flex flex-col">
          ...
          <div className="bg-dagger1 rounded-lg border border-dagger2 border-solid p-4 self-start w-full">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm text-dagger3">
                ...
                nec dui eget urna aliquet aliquam.
              </p>
            </div>
          </div>
        </div>
