                            ...
                            userPositions.map((position) => (
                                ...
                                >
                                    <TableCell>
                                        <div className="flex flex-row items-center gap-2">
                                                    ...
                                                    src={
                                                        tokens.find(
                                                            (token) =>
                                                                ...
                                                                position.pool.tokenX.id.toLowerCase()
                                                        )?.logo
                                                    }
                                                    alt={
                                                        position.pool.tokenX
                                                            .symbol
                                                    }
                                                ...
                                                <img
                                                    src={
                                                        tokens.find(
                                                            (token) =>
                                                                token.address.toLowerCase() ===
                                                                position.pool.tokenY.id.toLowerCase()
                                                        )?.logo
                                                    }
                                                    alt={
                                                        position.pool.tokenY
                                                            .symbol
                                                    }
                                                    className="rounded-full size-8"
                                                    style={{
                                            ...
                                            <div className="flex flex-col font-bold">
                                                {position.pool.tokenX.symbol}/
                                                {position.pool.tokenY.symbol}
                                    ...
                                    <TableCell className="text-right">
                                        $
                                        {(
                                            ((position.pool.reserveX *
                                                position.liquidity) /
                                                position.pool.liquidity) *
                                                prices[
                                                    position.pool.tokenX.symbol
                                                ] +
                                            ((position.pool.reserveY *
                                                position.liquidity) /
                                                position.pool.liquidity) *
                                                prices[
                                                    position.pool.tokenY.symbol
